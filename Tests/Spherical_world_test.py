...
class Game(ShowBase):
    def __init__(self):
        ...
        for iFace in range(np.size(world.f, 0)):
            ...
            tex_writer.addData2f(0.5, np.sqrt(3)/2)
        ...
        #image.imread(Root_Directory.Path() + "/Data/Tile_Data/soil_fertility_0.png")
        #tile.setTexture(Root_Directory.Path() + "/Data/Tile_Data/soil_fertility_0.png")

        tile.setTexture(loader.loadTexture("/c/Users/Xenath/PycharmProjects/untitled/Data/Tile_Data/soil_fertility_0.png"))
        #"C:\Users\Xenath\PycharmProjects\untitled\Data\Tile_Data\soil_fertility_0.png"
