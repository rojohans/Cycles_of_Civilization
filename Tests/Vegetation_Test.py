...
class Main():
    def __init__(self):
        ...
        Ecosystem.Vegetation.SeedWorld(5, Vegetation_Templates.FirForest, minFitness=0.7)

        #Ecosystem.Vegetation.SeedWorld(50, Vegetation_Templates.NormalGrass, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(20, Vegetation_Templates.NormalGrass, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(4, Vegetation_Templates.Jungle, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(10, Vegetation_Templates.SpruceForest, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(10, Vegetation_Templates.FirForest, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(10, Vegetation_Templates.PineForest, minFitness=0.2)
        Ecosystem.Vegetation.SeedWorld(10, Vegetation_Templates.BroadleafForest, minFitness=0.2)
        ...
        Ecosystem.Animal.SeedWorld(6, Animal_Templates.Boar, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(6, Animal_Templates.Turkey, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(10, Animal_Templates.Deer, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(10, Animal_Templates.Goat, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(3, Animal_Templates.Caribou, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(3, Animal_Templates.Bison, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(1, Animal_Templates.Llama, minFitness=0.2)
        Ecosystem.Animal.SeedWorld(3, Animal_Templates.Horse, minFitness=0.2)
