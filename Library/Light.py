...
class LightClass():
    def __init__(self, shadowsEnabled = False):
        ...
        ambientLight.setColor((0.1, 0.1, .1, 1))
        directionalLight = DirectionalLight("directionalLight")
        directionalLight.setDirection(LVector3(100, 100, -45))
        directionalLight.setColor((0.1, 0.1, 0.15, 1))
        ...
        directionalLight4.setColor((0.1, 0.1, 0.15, 1))
        '''
        ...
        dLight.setColor(Vec4(1, 1, 0.85, 1))
