...
class LightClass():
    def __init__(self, shadowsEnabled = False):
        ...
        directionalLight2.setColor((0.1, 0.1, 0.1, 1))
        ...
        directionalLight3.setColor((0.1, 0.1, 0.1, 1))
        ...
        directionalLight4.setColor((0.1, 0.1, 0.1, 1))
        ...
        if shadowsEnabled:
            ...
            directionalLightSun.setColor((1, 1, 1, 1))
