...
print(borderSideBottomProbability[:, -1])
print(sideBottomProbability[:, -1])
print(borderCornerBottomLeftBottomProbability[:, -1])
print(cornerBottomLeftProbability[:, -1])
...
for y in range(RESOLUTION):
    for x in range(RESOLUTION):
        ...
        filterCornerBottomRight.setPixel(x, y, (bottomRightCornerValue, bottomRightCornerValue, bottomRightCornerValue))
        ...
        filterAdjacentSideBottom.setPixel(x, y, (adjacentBottomSideValue, adjacentBottomSideValue, adjacentBottomSideValue))
        filterAdjacentSideRight.setPixel(x, y, (adjacentRightSideValue, adjacentRightSideValue, adjacentRightSideValue))
        filterAdjacentSideTop.setPixel(x, y, (adjacentTopSideValue, adjacentTopSideValue, adjacentTopSideValue))

        filterAdjacentCornerBottomLeftLeft.setPixel(x, y, (adjacentCornerBottomLeftLeftValue, adjacentCornerBottomLeftLeftValue, adjacentCornerBottomLeftLeftValue))
        filterAdjacentCornerBottomLeftBottom.setPixel(x, y, (adjacentCornerBottomLeftBottomValue, adjacentCornerBottomLeftBottomValue, adjacentCornerBottomLeftBottomValue))
        filterAdjacentCornerBottomRightBottom.setPixel(x, y, (adjacentCornerBottomRightBottomValue, adjacentCornerBottomRightBottomValue, adjacentCornerBottomRightBottomValue))
        filterAdjacentCornerBottomRightRight.setPixel(x, y, (adjacentCornerBottomRightRightValue, adjacentCornerBottomRightRightValue, adjacentCornerBottomRightRightValue))
        filterAdjacentCornerTopRightRight.setPixel(x, y, (adjacentCornerTopRightRightValue, adjacentCornerTopRightRightValue, adjacentCornerTopRightRightValue))
        filterAdjacentCornerTopRightTop.setPixel(x, y, (adjacentCornerTopRightTopValue, adjacentCornerTopRightTopValue, adjacentCornerTopRightTopValue))
        filterAdjacentCornerTopLeftTop.setPixel(x, y, (adjacentCornerTopLeftTopValue, adjacentCornerTopLeftTopValue, adjacentCornerTopLeftTopValue))
        filterAdjacentCornerTopLeftLeft.setPixel(x, y, (adjacentCornerTopLeftLeftValue, adjacentCornerTopLeftLeftValue, adjacentCornerTopLeftLeftValue))

filterCenter.write("models/topography_filter_center.jpg")

filterSideLeft.write("models/topography_filter_side_Left.jpg")
filterSideBottom.write("models/topography_filter_side_Bottom.jpg")
filterSideRight.write("models/topography_filter_side_Right.jpg")
filterSideTop.write("models/topography_filter_side_Top.jpg")

filterCornerBottomLeft.write("models/topography_filter_corner_Bottom_Left.jpg")
filterCornerBottomRight.write("models/topography_filter_corner_Bottom_Right.jpg")
filterCornerTopLeft.write("models/topography_filter_corner_Top_Left.jpg")
filterCornerTopRight.write("models/topography_filter_corner_Top_Right.jpg")

filterAdjacentSideLeft.write("models/topography_filter_adjacent_side_Left.jpg")
filterAdjacentSideBottom.write("models/topography_filter_adjacent_side_Bottom.jpg")
filterAdjacentSideRight.write("models/topography_filter_adjacent_side_Right.jpg")
filterAdjacentSideTop.write("models/topography_filter_adjacent_side_Top.jpg")

filterAdjacentCornerBottomLeftLeft.write("models/topography_filter_adjacent_corner_Bottom_Left_Left.jpg")
filterAdjacentCornerBottomLeftBottom.write("models/topography_filter_adjacent_corner_Bottom_Left_Bottom.jpg")
filterAdjacentCornerBottomRightBottom.write("models/topography_filter_adjacent_corner_Bottom_Right_Bottom.jpg")
filterAdjacentCornerBottomRightRight.write("models/topography_filter_adjacent_corner_Bottom_Right_Right.jpg")
filterAdjacentCornerTopRightRight.write("models/topography_filter_adjacent_corner_Top_Right_Right.jpg")
filterAdjacentCornerTopRightTop.write("models/topography_filter_adjacent_corner_Top_Right_Top.jpg")
filterAdjacentCornerTopLeftTop.write("models/topography_filter_adjacent_corner_Top_Left_Top.jpg")
filterAdjacentCornerTopLeftLeft.write("models/topography_filter_adjacent_corner_Top_Left_Left.jpg")
