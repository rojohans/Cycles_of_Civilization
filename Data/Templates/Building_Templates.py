...
class GrainFarm(Industry.ProductionBuilding):
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.outputBuffert.amount['grain'] += 2 * usedLabor
...
class Household(Industry.LivingBuilding):
    def __init__(self):
        inputBuffert = Industry.ResourceBuffert(types=['grain', 'spent_labor'], amounts=[50, 0], limits=[100, 100])
